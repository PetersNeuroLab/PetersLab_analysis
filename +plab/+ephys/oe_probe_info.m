...
probe = struct( ...
    ...
    'xc',reshape(electrode_x(channel_sort_idx),1,[]),...
    'yc',reshape(electrode_y(channel_sort_idx),1,[]),...
    'kcoords',reshape(electrode_shank(channel_sort_idx),1,[]),... % shank or channel group
    'n_chan',n_chan, ...
